...
/** Brand marks aren't part of lucide 1.x, so we ship them as inline SVGs. */
...
export function XTwitterIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" {...props}>
      <path d="M18.24 2.25h3.31l-7.23 8.26 8.5 11.24h-6.66l-5.22-6.82-5.96 6.82H.66l7.73-8.84L0 2.25h6.83l4.71 6.23 5.7-6.23Zm-1.16 17.52h1.83L6.99 4.13H5.03l12.05 15.64Z" />
    </svg>
  )
}
